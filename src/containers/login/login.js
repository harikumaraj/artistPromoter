        ...
        fetch('https://datspot.com/api/auth', {
            ...
            .then(([statusCode, data])=>{
                ...
                if(statusCode===200){
                    ...
                    if(data.data.user.acc_type==="artist")
                    this.props.navigation.navigate("ArtistNavigator");
                    else if(data.data.user.acc_type==="club")
                        this.props.navigation.navigate("clubNavigator");
                    else{
                        this.props.navigation.navigate("promoterNavigator");
                    }
                }
                else {
                }
                ...
                <View style={ style.container }>
                    ...
                    <View style={style.loginWithWrapper}>
                        ...
                        <View style={style.socialMediaContainer}>
                            <TouchableOpacity style={[style.socialMediaIconContainer,{backgroundColor:"rgb(54, 85, 157)"}]}>
                                <FontAwesome name={"facebook"} size={25} color={"#fff"}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={[style.socialMediaIconContainer,{backgroundColor:"rgb(26, 178, 232)"}]}>
                                <FontAwesome name={"twitter"} size={25} color={"#fff"}/>
                            </TouchableOpacity>
                            <TouchableOpacity style={[style.socialMediaIconContainer,{backgroundColor:"rgb(58, 55, 55)"}]}>
