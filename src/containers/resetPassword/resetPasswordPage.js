                ...
                <View style={ style.container }>
                    ...
                    >
                        ...
                        <View style={{flex:1, marginTop:"3%",alignItems:"center", justifyContent:"flex-end"}}>
                            <Text style={{color:"#fff"}}>Already have an account? <Text onPress={()=>{this.props.navigation.navigate("LoginScreen")}} style={{color:"rgb( 240, 66, 131)"}}>Sign in here.</Text></Text>
                        </View>
                    </View>
                </View>
            </ImageBackground>
